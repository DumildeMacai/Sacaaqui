...
function AtmList({ atms }) {
    _s();
    const [internalAtms, setInternalAtms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(atms);
                ...
                "AtmList.useEffect.unsubscribe": (user)=>{
                    ...
                    if (user) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(userDocRef).then({
                            "AtmList.useEffect.unsubscribe": (userDoc)=>{
                                if (userDoc.exists()) {
...
_s(AtmList, "3W07sDWj6eQ74v5F8Wh4VOg9uHc=");
_c = AtmList;
var _c;
...
function DashboardPage() {
    ...
    const filteredAtms = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[filteredAtms]": ()=>{
            if (!searchTerm) {
                return atms;
            }
            return atms.filter({
                "DashboardPage.useMemo[filteredAtms]": (atm)=>atm.name.toLowerCase().includes(searchTerm.toLowerCase()) || atm.address.toLowerCase().includes(searchTerm.toLowerCase())
            }["DashboardPage.useMemo[filteredAtms]"]);
        }
    }["DashboardPage.useMemo[filteredAtms]"], [
        atms,
...
_s(DashboardPage, "LGgTdIIugIcf/5zoAiIHC057Ln4=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_75037e30._.js.map