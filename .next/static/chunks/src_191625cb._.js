            ...
            const fetchDashboardData = {
                "AdminDashboardPage.useEffect.fetchDashboardData": async ()=>{
                    try {
                        ...
                        const atms = atmsSnapshot.docs.map({
                            "AdminDashboardPage.useEffect.fetchDashboardData.atms": (doc)=>doc.data()
                        }["AdminDashboardPage.useEffect.fetchDashboardData.atms"]);
                        ...
                        atms.forEach({
                            "AdminDashboardPage.useEffect.fetchDashboardData": (atm)=>{
