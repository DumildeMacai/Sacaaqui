        ...
        "AdminDashboardPage.useEffect": ()=>{
            const fetchData = {
                "AdminDashboardPage.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$3a34cf__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDashboardData"])();
                        setData(result);
                    } catch (err) {
...
//# sourceMappingURL=src_c05cce1f._.js.map