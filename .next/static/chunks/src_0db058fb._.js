...
function AdminPanelPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPanelPage.useEffect": ()=>{
            const fetchAtms = {
                "AdminPanelPage.useEffect.fetchAtms": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        if (atmsSnapshot.empty) {
                            ...
                            const atmsData = atmsSnapshot.docs.map({
                                "AdminPanelPage.useEffect.fetchAtms.atmsData": (doc)=>{
                                    const data = doc.data();
                                    const reports = (data.reports || []).map({
                                        "AdminPanelPage.useEffect.fetchAtms.atmsData.reports": (report)=>({
                                                ...report,
                                                timestamp: convertTimestampToString(report.timestamp)
                                            })
                                    }["AdminPanelPage.useEffect.fetchAtms.atmsData.reports"]);
                                    return {
                                        id: doc.id,
                                        name: data.name || '',
                            ...
                            }["AdminPanelPage.useEffect.fetchAtms.atmsData"]);
                            setAtms(atmsData);
                        }
                    } catch (err) {
                        console.error(err);
            ...
            }["AdminPanelPage.useEffect.fetchAtms"];
            fetchAtms();
        }
    }["AdminPanelPage.useEffect"], []);
    if (error) {
...
_s(AdminPanelPage, "l5FVspY+zQywILZ3tZR85P9VoSw=");
_c = AdminPanelPage;
var _c;
...
//# sourceMappingURL=src_0db058fb._.js.map